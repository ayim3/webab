...
function timeElapse(date) {
	...
	var result = "Os dias Importam: <span class=\"digit\">" + days + "</span> Dias <span class=\"digit\"> " + hours + " </span>Hours <span class=\"digit\"> " + minutes + " </span>Mins <span class=\"digit\"> " + seconds + " </span>Secs";
